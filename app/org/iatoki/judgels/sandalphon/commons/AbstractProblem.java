...
public abstract class AbstractProblem {
    ...
    public AbstractProblem(String jid, ProblemType type) {
        this.id = -1;
        this.jid = jid;
        this.name = null;
        this.authorJid = null;
    ...
    public AbstractProblem(long id, String jid, String name, String authorJid, Date lastUpdate, ProblemType type) {
        this.id = id;
        this.jid = jid;
        this.name = name;
